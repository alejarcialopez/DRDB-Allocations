...
# The first-task source will be mounted here as a volume
VOLUME /usr/src/app
...
ENV DJANGO_SETTINGS_MODULE first_task_project.settings_developer
ENTRYPOINT ["/tmp/wait-for-it.sh", "first-task-db:5432", "--"]
