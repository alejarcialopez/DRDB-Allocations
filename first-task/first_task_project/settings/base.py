...
#: complain.
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'first-task-fuas3saiyeib8eiVaezohdoo7jee4ro6leVieCahtaiboocioguezu8iafi2Oote')
...
#: Root URL patterns
ROOT_URLCONF = 'first_task_project.urls'
...
#: WSGI
WSGI_APPLICATION = 'first_task_project.wsgi.application'
